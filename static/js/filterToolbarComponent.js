...
const FilterToolbarContainer = {
    ...
    methods: {
        ...
        getSingleFilterOptions(issues, field){
            optsSet = new Set()
            options = []
            issues.forEach(issue => {
                value = issue[field]
        ...
        async fetchOptions(){
            ...
            this.types_options = this.getSingleFilterOptions(data, 'type')
            this.source_options = this.getSingleFilterOptions(data, 'source_type')
            this.tags_options = this.getMultiFilterOptions(data)
        },
