...
from plugins.engagements.serializers.attachment import attachment_schema
...
class API(flask_restful.Resource):  # pylint: disable=R0903
    ...
    @auth.decorators.check_api({
        "permissions": ["engagements.engagements.attachments.edit"],
        "recommended_roles": {
    ...
    @auth.decorators.check_api({
        "permissions": ["engagements.engagements.attachments.delete"],
        "recommended_roles": {
